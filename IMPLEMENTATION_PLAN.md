...
This index tracks active and completed implementation plans for AqOne.
Per [`AGENTS.md`](AGENTS.md) and [`docs/README.md`](docs/README.md), only one plan may be **ACTIVE** at any given time.
...
| Plan | Status | Focus / Description |
|---|---|---|
| [`docs/archive/plans/44_DASHBOARD_LAYOUT_REDESIGN_IMPLEMENTATION_PLAN.md`](docs/archive/plans/44_DASHBOARD_LAYOUT_REDESIGN_IMPLEMENTATION_PLAN.md) | COMPLETE | Layout-only refresh of operations dashboard |
| [`docs/archive/plans/45_DASHBOARD_LOGIN_BYPASS_IMPLEMENTATION_PLAN.md`](docs/archive/plans/45_DASHBOARD_LOGIN_BYPASS_IMPLEMENTATION_PLAN.md) | COMPLETE | Offline and demo authentication bypass |
| [`docs/archive/plans/48_DOCS_REORGANIZATION_IMPLEMENTATION_PLAN.md`](docs/archive/plans/48_DOCS_REORGANIZATION_IMPLEMENTATION_PLAN.md) | COMPLETE | Initial documentation indexing and audit archiving |
